...
RSpec.describe HoteisController, :type => :controller do
  ...
  # HoteisController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all hoteis as @hoteis" do
      hotel = Hotel.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:hoteis)).to eq([hotel])
    end
  end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the hoteis list" do
      hotel = Hotel.create! valid_attributes
      delete :destroy, {:id => hotel.to_param}, valid_session
      expect(response).to redirect_to(hoteis_url)
    end
  end
